        ...
        return (
            <div className="welcome-container">
                <div className="content">
                    ...
                    <br/><img alt="main-page-gif" src={mainGif}/></h1>
                    ...
                    <h1 className="frame-4"><img alt="connections-vector" src={connection} /><span>Form a mutual connection when you and another professional swipe right</span></h1>
                    <h1 className="frame-5">Start Connecting!<img alt="connection-gif" src={network}/></h1>
                </div>
            </div>
        )
    }
